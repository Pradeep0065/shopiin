            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="name" placeholder="Enter Fullname" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="phone" placeholder="Enter mob. no." required>
                                            <div class="invalid-feedback">
                                                Please enter mob. no.
                                            </div>
                                        </div>
                                        ...
                                        <div id="register-alert" class="alert alert-danger text-danger" style="display: none;">All fields are required</div>

                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" id="register" type="button">Sign Up</button>
                                        </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Already have an account ? <a href="{{url('/')}}" class="fw-semibold text-primary text-decoration-underline"> Sigin </a> </p>
                        </div>
