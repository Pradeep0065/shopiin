                                        ...
                                        <table class="table table-nowrap table-centered align-middle">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{url('public/assets/images/users/avatar-1.jpg')}}" class="avatar-xxs rounded-circle me-1 material-shadow" alt="">
                                                        ...
                                                        <div class="avatar-group flex-nowrap">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{url('public/assets/images/users/avatar-1.jpg')}}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{url('public/assets/images/users/avatar-2.jpg')}}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{url('public/assets/images/users/avatar-3.jpg')}}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{url('public/assets/images/users/avatar-2.jpg')}}" class="avatar-xxs rounded-circle me-1 material-shadow" alt="">
                                                    ...
                                                    <td>
                                                        <div class="avatar-group">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{url('public/assets/images/users/avatar-5.jpg')}}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{url('public/assets/images/users/avatar-6.jpg')}}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{url('public/assets/images/users/avatar-3.jpg')}}" class="avatar-xxs rounded-circle me-1 material-shadow" alt="">
                                                    ...
                                                    <td>
                                                        <div class="avatar-group">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{url('public/assets/images/users/avatar-7.jpg')}}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{url('public/assets/images/users/avatar-8.jpg')}}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{url('public/assets/images/users/avatar-5.jpg')}}" class="avatar-xxs rounded-circle me-1 material-shadow" alt="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{url('public/assets/images/users/avatar-6.jpg')}}" class="avatar-xxs rounded-circle me-1 material-shadow" alt="">
                                                    ...
                                                    <td>
                                                        <div class="avatar-group">
                                                            ...
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{url('public/assets/images/users/avatar-4.jpg')}}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
                                    ...
                                    <div class="table-responsive table-card">
                                        <table class="table table-borderless table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="{{url('public/assets/images/users/avatar-1.jpg')}}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="{{url('public/assets/images/users/avatar-2.jpg')}}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="{{url('public/assets/images/users/avatar-7.jpg')}}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="{{url('public/assets/images/users/avatar-4.jpg')}}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="{{url('public/assets/images/users/avatar-6.jpg')}}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="{{url('public/assets/images/users/avatar-5.jpg')}}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        <img src="{{url('public/assets/images/users/avatar-3.jpg')}}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                                        <div>
                                                ...
                                                <li class="chat-list left">
                                                    <div class="conversation-list">
                                                        <div class="chat-avatar">
                                                            <img src="{{url('public/assets/images/users/avatar-2.jpg')}}" alt="" class="material-shadow">
                                                        </div>
                                                            ...
                                                            <div class="ctext-wrap">
                                                                <div class="message-img mb-0">
                                                                    <div class="message-img-list">
                                                                        <div>
                                                                            <a class="popup-img d-inline-block" href="{{url('public/assets/images/small/img-1.jpg')}}">
                                                                        ...
                                                                        <div class="message-img-link">
                                                                            <ul class="list-inline mb-0">
                                                                                <li class="list-inline-item dropdown">
                                                                                    ...
                                                                                    <div class="dropdown-menu">
                                                                                        <a class="dropdown-item" href="{{url('public/assets/images/small/img-1.jpg')}}" download=""><i class="ri-download-2-line me-2 text-muted align-bottom"></i>Download</a>
                                                                                        <a class="dropdown-item" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Reply</a>
                                                                                        <a class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward</a>
                                                                                        <a class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>Bookmark</a>
                                                                                        <a class="dropdown-item delete-item" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>Delete</a>
                                                                    ...
                                                                    <div class="message-img-list">
                                                                        <div>
                                                                            <a class="popup-img d-inline-block" href="{{url('public/assets/images/small/img-2.jpg')}}">
                                                                        ...
                                                                        <div class="message-img-link">
                                                                            <ul class="list-inline mb-0">
                                                                                <li class="list-inline-item dropdown">
                                                                                    ...
                                                                                    <div class="dropdown-menu">
                                                                                        <a class="dropdown-item" href="{{url('public/assets/images/small/img-2.jpg')}}" download=""><i class="ri-download-2-line me-2 text-muted align-bottom"></i>Download</a>
                                                                                        <a class="dropdown-item" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Reply</a>
                                                                                        <a class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward</a>
                                                                                        <a class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>Bookmark</a>
                                                                                        <a class="dropdown-item delete-item" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>Delete</a>
