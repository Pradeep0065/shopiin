<main class="main">
    <div class="home-slider slide-animate owl-carousel owl-theme show-nav-hover nav-big mb-2 text-uppercase" data-owl-options="{
        ...
        <div class="home-slide home-slide1 banner">
            <img class="slide-bg" src="{{url('public/web/assets/images/demoes/demo4/slider/slide-1.jpg')}}" width="1903" height="499" alt="slider image">
            <div class="container d-flex align-items-center">
                <div class="banner-layer appear-animate" data-animation-name="fadeInUpShorter">
                    ...
                    <a href="{{url('category.html')}}" class="btn btn-dark btn-lg">Shop Now!</a>
                </div>
                <!-- End .banner-layer -->
            </div>
        </div>
        ...
        <div class="home-slide home-slide2 banner banner-md-vw">
            <img class="slide-bg" style="background-color: #ccc;" width="1903" height="499" src="{{url('public/web/assets/images/demoes/demo4/slider/slide-2.jpg')}}" alt="slider image">
            <div class="container d-flex align-items-center">
                <div class="banner-layer d-flex justify-content-center appear-animate" data-animation-name="fadeInUpShorter">
                    <div class="mx-auto">
                        ...
                        <a href="{{url('#')}}" class="btn btn-block btn-dark">Shop All Sale</a>
                    </div>
                </div>
                <!-- End .banner-layer -->
            </div>
        ...
        <div class="banners-container mb-2">
            <div class="banners-slider owl-carousel owl-theme" data-owl-options="{
                ...
                <div class="banner banner1 banner-sm-vw d-flex align-items-center appear-animate" style="background-color: #ccc;" data-animation-name="fadeInLeftShorter" data-animation-delay="500">
                    <figure class="w-100">
                        <img src="{{url('public/web/assets/images/demoes/demo4/banners/banner-1.jpg')}}" alt="banner" width="380" height="175" />
                    </figure>
                    <div class="banner-layer">
                        <h3 class="m-b-2">Porto Watches</h3>
                        <h4 class="m-b-3 text-primary"><sup class="text-dark"><del>20%</del></sup>30%<sup>OFF</sup></h4>
                        <a href="{{url('category.html')}}" class="btn btn-sm btn-dark">Shop Now</a>
                    </div>
                </div>
                <!-- End .banner -->
                ...
                <div class="banner banner2 banner-sm-vw text-uppercase d-flex align-items-center appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="200">
                    <figure class="w-100">
                        <img src="{{url('public/web/assets/images/demoes/demo4/banners/banner-2.jpg')}}" style="background-color: #ccc;" alt="banner" width="380" height="175" />
                    </figure>
                ...
                <div class="banner banner3 banner-sm-vw d-flex align-items-center appear-animate" style="background-color: #ccc;" data-animation-name="fadeInRightShorter" data-animation-delay="500">
                    <figure class="w-100">
                        <img src="{{url('public/web/assets/images/demoes/demo4/banners/banner-3.jpg')}}" alt="banner" width="380" height="175" />
                    </figure>
    ...
    <section class="featured-products-section">
        <div class="container">
            ...
            <div class="products-slider custom-products owl-carousel owl-theme nav-outer show-nav-hover nav-image-center" data-owl-options="{
                ...
                @if($i < 5) <div class="product-default appear-animate" data-animation-name="fadeInRightShorter">
                    <figure>
    ...
    <section class="new-products-section">
        <div class="container">
            ...
            <div class="products-slider custom-products owl-carousel owl-theme nav-outer show-nav-hover nav-image-center mb-2" data-owl-options="{
                ...
                @if($i < 6) <div class="product-default appear-animate" data-animation-name="fadeInRightShorter">
                    <figure>
                        <a href="{{url('product-detail/'.$item->p_name)}}">
                            <img src="{{url('public/images/'.$item->img)}}" style="height:200px !important" alt="product">
                            <img src="{{url('public/images/'.$item->img)}}" style="height:200px !important" alt="product">
                    ...
                    <div class="product-details">
                        <div class="category-list">
                            <a href="{{url('product-detail/'.$item->p_name)}}" class="product-category">Category</a>
                        </div>
                        <h3 class="product-title">
                            <a href="{{url('product-detail/'.$item->p_name)}}">{{$item->p_name}}</a>
                        </h3>
        ...
        <div class="banner banner-big-sale appear-animate" data-animation-delay="200" data-animation-name="fadeInUpShorter" style="background: #2A95CB center/cover url('public/web/assets/images/demoes/demo4/banners/banner-4.jpg')');">
            <div class="banner-content row align-items-center mx-0">
                ...
                <div class="col-md-3 col-sm-4 text-center text-sm-right">
                    <a class="btn btn-light btn-white btn-lg" href="{{url('category.html')}}">View Sale</a>
                </div>
            </div>
        </div>
        ...
        <div class="categories-slider owl-carousel owl-theme show-nav-hover nav-outer">
            ...
            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                <a href="{{url('show-all-data/'.$item->c_name)}}">
    ...
    <section class="promo-section bg-dark" data-parallax="{'speed': 2, 'enableOnMobile': true}" data-image-src="{{url('public/web/assets/images/demoes/demo4/banners/banner-5.jpg')}}">
        <div class="promo-banner banner container text-uppercase">
            <div class="banner-content row align-items-center text-center">
                ...
                <div class="col-md-4 col-xl-3 pb-4 pb-md-0 appear-animate" data-animation-name="fadeIn" data-animation-delay="300">
                    <a href="{{url('category.html')}}" class="btn btn-dark btn-black ls-10">View Sale</a>
                </div>
    ...
    <section class="blog-section pb-0">
        <div class="container">
            ...
            <div class="owl-carousel owl-theme appear-animate" data-animation-name="fadeIn" data-owl-options="{
                ...
                <article class="post">
                    <div class="post-media">
                        <a href="{{url('#')}}">
                            <img src="{{url('public/web/assets/images/blog/home/post-1.jpg')}}" alt="Post" width="225" height="280">
                        </a>
                        <div class="post-date">
                ...
                <article class="post">
                    <div class="post-media">
                        <a href="{{url('#')}}">
                            <img src="{{url('public/web/assets/images/blog/home/post-2.jpg')}}" alt="Post" width="225" height="280">
                        </a>
                        <div class="post-date">
                            <span class="day">26</span>
                            <span class="month">Feb</span>
                ...
                <article class="post">
                    <div class="post-media">
                        <a href="{{url('#')}}">
                            <img src="{{url('public/web/assets/images/blog/home/post-3.jpg')}}" alt="Post" width="225" height="280">
                        </a>
                        <div class="post-date">
                            <span class="day">26</span>
                            <span class="month">Feb</span>
                ...
                <article class="post">
                    <div class="post-media">
                        <a href="{{url('#')}}">
                            <img src="{{url('public/web/assets/images/blog/home/post-4.jpg')}}" alt="Post" width="225" height="280">
                        </a>
                        <div class="post-date">
                            <span class="day">26</span>
                            <span class="month">Feb</span>
                    ...
                    <div class="post-body">
                        <h2 class="post-title">
                            <a href="{{url('#')}}">Perfect Accessories</a>
                        </h2>
                        <div class="post-content">
                            <p>Leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of...</p>
                        </div>
            ...
            <div class="categories-slider owl-carousel owl-theme show-nav-hover nav-outer">
                ...
                <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                    <a href="{{url('show-all-brand/'.$item->b_name)}}">
