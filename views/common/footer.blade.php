  ...
  <button onclick="topFunction()" class="btn btn-danger btn-icon" id="back-to-top">
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme01">
                                    <img src="../../{{url('public/assets/images/demo/default.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme02">
                                    <img src="../../{{url('public/assets/images/demo/saas.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme03">
                                    <img src="../../{{url('public/assets/images/demo/corporate.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme04">
                                    <img src="../../{{url('public/assets/images/demo/galaxy.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme05">
                                    <img src="../../{{url('public/assets/images/demo/material.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme06">
                                    <img src="../../{{url('public/assets/images/demo/creative.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme07">
                                    <img src="../../{{url('public/assets/images/demo/minimal.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme08">
                                    <img src="../../{{url('public/assets/images/demo/modern.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme09">
                                    <img src="../../{{url('public/assets/images/demo/interactive.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme10">
                                    <img src="../../{{url('public/assets/images/demo/classic.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme11">
                                    <img src="../../{{url('public/assets/images/demo/vintage.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="{{url('public/assets/images/sidebar/img-1.jpg')}}" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>	
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="{{url('public/assets/images/sidebar/img-2.jpg')}}" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-03" value="img-3">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="{{url('public/assets/images/sidebar/img-3.jpg')}}" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-04" value="img-4">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="{{url('public/assets/images/sidebar/img-4.jpg')}}" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <!-- projects js -->
    <script src="{{url('public/assets/js/pages/dashboard-projects.init.js')}}"></script>
